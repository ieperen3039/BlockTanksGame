...
{ // accolades around entire file (as the JSON standard dictates)
  ...
  "blocks" : { // all fields are optional
    "/name of the block, may include spaces/" : {
      ...
      // for collision, also [/integer width x/, /integer width y/, /integer height z/] is accepted, where a block-shaped collision box of the given block-size is used
      "size" : [/integer width x/, /integer width y/, /integer height z/], // in units of a 1x1x1 block
