...
import NG.Blocks.Types.PieceTypeBlock;
...
public class BasicBlocks implements PieceTypeCollection {
    ...
    private static final Map<Vector3ic, PieceTypeBlock> cache = new HashMap<>();
    ...
    public static PieceTypeBlock get(Vector3ic size) {
    ...
    private static PieceTypeBlock get(int xSize, int ySize, int zSize, Vector3ic size) {
        ...
        PieceTypeBlock newBlock = new PieceTypeBlock(
    ...
    public static PieceTypeBlock getPlate(int xSize, int ySize) {
